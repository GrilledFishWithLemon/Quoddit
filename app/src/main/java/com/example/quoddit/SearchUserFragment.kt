...
import com.example.quoddit.Adapter.UserAdapter
...
class SearchUserFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.searchUser_edit_text.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                if(view.searchUser_edit_text.text.toString() == ""){
